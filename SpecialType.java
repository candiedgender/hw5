...
/**
 * A special type pokemon
 *
 * @author cproenza3
 * @version 2
 */
public abstract class SpecialType extends Pokemon {
     ...
     */
    public SpecialType(int x, int y, Rectangle bounds) {
        super(x, y, bounds);
    }
    ...
    public boolean canHarmPokemon(Pokemon otherPokemon) {
        if (collidesWithPokemon(otherPokemon)) {
            ...
            if (otherPokemon instanceof WaterType && num < 50) {
                ...
                return true;
            } else if (otherPokemon instanceof SpecialType && num < 80) {
                return true;
            }
        }
        return false;
